<!--
ARCHIVED 2026-06-03 (v1). This is the frozen-probe-era architecture, written when multi-view
DINOv3 was the deployed model and LoRA was still experimental. It is SUPERSEDED by the single
fine-tuned SigLIP-2 deploy; see the current docs/architecture.md. Kept verbatim as a record of
the journey - do not treat as current.
-->
